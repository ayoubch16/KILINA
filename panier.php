            ...
            <div class="col bg-white rounded p-4 my-1 mx-2">
                ...
                ?>
                    <div class="row">
                        ...
                        <div class="col-sm text-left">
                            ...
                            <p style="font-size: 10px;">Réfe : <input style="border: none;" readonly type="text" value="<?php echo $row1['Ref'];?>" name="ref<?php echo $cpt;?>" id=""></p>
                            <div class="row my-3">
                                <div class="col">
                                ...
                                <div class="col">
                                    ...
                                    <input onchange="claculer()" class="qnt" type="number" name="Qnt<?php echo $cpt;?>" style="width: 50px;  -moz-appearance: textfield;" value="1" min="1" >
                                </div>
                            </div>
                            <div class="my-3">
                ...
                <div class="col-md-4 col-sm bg-white rounded p-4 my-1 mx-2">
                        ...
                        <div class="row text-center">
                            <input class="mx-2 rounded col" type="text"  style="background-color: #EEECF5; color: #19AA09;">
