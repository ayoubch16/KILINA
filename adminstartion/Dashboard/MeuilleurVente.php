...
<body>
<style>.dot{width:10px;height:10px;border-radius:50%}.edit .img1{filter:brightness(0%)}.edit .img1:hover{filter:brightness(100%)}.edit .img2{filter:brightness(100%)}.edit .img2:hover{filter:brightness(0%)}.barRech{background-color:#fff;padding:10px;border-radius:10px;margin-bottom:20px;width:350px;height:60px;box-shadow:-2px 11px 13px -15px #000}.barRech input[type="text"]{border:0;border-bottom:1px solid #f2f2f2;width:300px;height:40px;margin-right:10px}.btnAjoute{background-color:#fcea01;color:#000;padding:10px;min-width:150px}</style>
<script>document.title="Meuilleur Vente";</script>
...
<?php   $cpt=0;
                                                       ...
                                                       ?>
<tr>
<td class="text-left"><img width="30" height="30" src="<?php echo 'data:image/jpeg;base64,' . base64_encode($row['img1']); ?>" alt=""></td>
