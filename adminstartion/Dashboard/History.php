...
<body>
    ...
    <script>
    document.title = "History des Operations";
    </script>
    <script>
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <div class="barRech">
                        <input id="myInput" type="text"><span><img src="img/icons/search.png" width="20" height="20"
                                alt=""></span>
                    </div>
                    <div class="row">
                                                       ...
                                                       ?>
                                                        <tr>
                                                            <td class="text-left">
                                                                <?php 
                                                                    $reff=$row['Reffuser'];
                                                                    $sqlref="SELECT * FROM `users` WHERE `Reffuser`='$reff' ";
                                                                    $resultref = $cnx->query($sqlref);
