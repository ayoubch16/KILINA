                                            ...
                                            <div class="table-responsive table-upgrade">
                                                <table class="table">
                                                    ...
                                                    <tbody id="myTable">
                                                        ...
                                                        ?>
                                                        <tr>
                                                            <td class="text-left"><img src="<?php echo 'data:image/jpeg;base64,' . base64_encode($row['image']); ?>"
                                                            ...
                                                            <td class="text-left edit">
                                                                <a href="<?php echo $row['localisation'];?>"><img src="img/icons/placeholder.png"
                        ...
                        <form class="needs-validation border p-4" action="boutique.php" method="POST" novalidate enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md mb-3">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom01" placeholder="Ville" name="ville"
                                        required>
                                </div>
                                <div class="col-md mb-3">
                                    <label for="validationCustom02">Adresse</label>
                                    <input type="text" class="form-control" id="validationCustom02" placeholder="Adresse" name="adresse"
                                        required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md mb-3">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom03" placeholder="Telephone" name="tele"
                                        required>
                                </div>
                                <div class="col-md mb-3">
                                    <label for="validationCustom04">Lien</label>
                                    <input type="lien" class="form-control" id="validationCustom04" placeholder="lienMaps" name="lien"
                                        required>
                                </div>
                            </div>
                            <div class="row">
