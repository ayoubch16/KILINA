...
<body>
<style>.barRech{background-color:#fff;padding:10px;border-radius:10px;margin-bottom:20px;width:350px;height:60px;box-shadow:-2px 11px 13px -15px #000}.barRech input[type="text"]{border:0;border-bottom:1px solid #f2f2f2;width:300px;height:40px;margin-right:10px}.statusL,.statusL a{color:#08cf07;background-color:#9dfb9d;padding:4px;border-radius:5px}.statusA,.statusA a{color:#fc4b4b;background-color:#fd9b9b;padding:4px;border-radius:5px}.statusE,.statusE a{color:#c2c800;background-color:#fcff99;padding:3px;border-radius:5px}.bardelai{background-color:#fff;border-radius:10px;padding:5px;height:50px;display:flex;justify-content:start;align-items:center}.statusF{background-color:#313233;border-radius:10px;padding:5px;width:50px;height:50px;display:flex;justify-content:start;align-items:center}.bardelai input[type="date"]{background-color:#f6f6f6;border:1px solid #d9d9d9;width:250px;height:40px;border-radius:10px;padding:5px;margin:5px}.bardelai input[type="submit"]{background-color:#fcea01;border:1px solid #fcea01;width:250px;height:40px;border-radius:10px;padding:5px;margin:5px}.bardelai input[type="submit"]:hover{background-color:#000;border:1px solid #000;color:#fcea01}.barfilter{background-color:#fff;border-radius:10px;padding:5px;height:50px;width:auto;display:flex;justify-content:end;align-items:center}#info{display:none}</style>
<script>document.title="Commandes";</script>
...
<style>.card input[type="text"],.card select{width:100%;height:50px;border:1px solid #c3cdd5;background-color:#f8f9fa;border-radius:5px;margin:10px}.btnM{background-color:#000;color:#fff;border-radius:5px;padding:10px;margin:5px}.btnM:hover{background-color:#fff;color:#000;text-decoration:none}</style>
...
<script>function afficher(d,a,e,f,c,g,b){document.getElementById("info").style.display="block";document.getElementById("wrapper").style.filter="grayscale(49%) sepia(27%) blur(4px) brightness(47%) saturate(71%)";document.getElementById("nom").value=d;document.getElementById("tele").value=a;document.getElementById("adresse").value=e;document.getElementById("ref").value=f;document.getElementById("prix").value=c;document.getElementById("ville").value=g}function fermer(){document.getElementById("info").style.display="none";document.getElementById("wrapper").style.filter="none"};</script>
