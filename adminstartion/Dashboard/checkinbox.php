...
<form action="">
        ...
        <div class="flex-item "><img src="img/photos/felicitation.png" width="200" height="200" alt=""></div>
        <div class="flex-item "> <h2>Merci de Verifier </h2></div>
        <div class="flex-item "> <h5>Votre boite Email </h5></div>
