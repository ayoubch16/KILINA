...
include 'header.php';?>
<body>
<style>.edit img{filter:brightness(0%)}.edit img:hover{filter:brightness(100%)}iframe{width:150px;height:250px}.cv{position:absolute;top:10%;left:30%;right:30%;width:40%;height:80%;padding:10px}#cv{display:none}</style>
<script>document.title="Gestion du Recrutement";</script>
<div class="wrapper">
...
<script>function afficher(a){document.getElementById("cv").style.display="block";document.getElementById("cvT").src=a}function fermer(){document.getElementById("cv").style.display="none"};</script>
