<style>.parent{position:fixed;top:230px;left:0;display:grid;z-index:-9}.parent img{filter:brightness(0%)}.parent img:hover{filter:brightness(100%)}.div1 p{transform:rotate(-90deg)}.div2{grid-area:2 / 1 / 3 / 2;text-align:center}.div3{grid-area:3 / 1 / 4 / 2;text-align:center}.div4{grid-area:4 / 1 / 5 / 2;text-align:center}.div5{grid-area:5 / 1 / 6 / 2;text-align:center}</style>
<div class="parent">
